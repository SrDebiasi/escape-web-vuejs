  ...
  <v-app>
    <v-stepper v-model="step" alt-labels light>
      <v-stepper-header>
        ...
        <v-stepper-step :complete="step > 3" step="2">{{ $t('common.date') }}</v-stepper-step>

        <v-divider></v-divider>

        <v-stepper-step step="3">{{ $t('common.personal_data') }}</v-stepper-step>
      </v-stepper-header>
      ...
      <v-stepper-items>
        ...
        <v-stepper-content step="2">
          ...
          <v-btn text @click="stepOne()">{{ $t('common.back') }}</v-btn>
        </v-stepper-content>
...
export default {
  ...
  mounted() {
    this.locale = !this.$route.query.locale ? this.locale : this.$route.query.locale
    ...
    this.step = this.room != undefined ? 2 : 1
